...
// Import to-words npm package. Documentation can be found here: https://www.npmjs.com/package/to-words
...
router.post('/'+ version +'/application/capital-shares-company', function(req, res) {
   res.redirect("capital-shares-number-now")
});
router.post('/'+ version +'/application/capital-shares-number-now', function(req, res) {
   res.redirect("capital-shares-number-backdating")
});
router.post('/'+ version +'/application/capital-shares-number-backdating', function(req, res) {
